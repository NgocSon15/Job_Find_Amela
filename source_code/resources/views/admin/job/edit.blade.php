...
@section('content-name', 'Sửa tin tuyển dụng')
@section('content')
        ...
        <div class="d-flex">
            <div class="col-lg-6" style="padding-right: 40px;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="job_title" name="job_title" placeholder="Nhập tiêu đề công việc" value="{{ old('job_title') ?? $job->job_title}}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="min_salary" name="min_salary" value="{{ old('min_salary') ?? $job->min_salary }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="max_salary" name="max_salary" value="{{ old('max_salary') ?? $job->max_salary }}">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <textarea class="form-control" name="job_description">{{ old('job_description') ?? $job->job_description }}</textarea>
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="experiences" name="experiences" value="{{ old('experiences') ?? $job->experiences }}">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="expiration" name="expiration" value="{{ old('expiration') ?? $job->expiration }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="quantity" name="quantity" value="{{ old('quantity') ?? $job->quantity }}">
